...
public class PurifierGui extends GuiContainer
{
    ...
    private PurifierTileEntity tileFurnace;
    private static final String __OBFID = "CL_00000758";

    public PurifierGui(InventoryPlayer par1InventoryPlayer, PurifierTileEntity par2TileEntityIronOvenIdle)
    {
        super(new PurifierContainer(par1InventoryPlayer, par2TileEntityIronOvenIdle));
        this.tileFurnace = par2TileEntityIronOvenIdle;
    }
