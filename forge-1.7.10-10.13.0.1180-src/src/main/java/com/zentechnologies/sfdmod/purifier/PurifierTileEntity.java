...
public class PurifierTileEntity extends TileEntity implements ISidedInventory
{
    ...
    public void readFromNBT(NBTTagCompound p_145839_1_)
    {
        ...
        this.currentItemBurnTime = getItemEmptyTime(this.furnaceItemStacks[1]);
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                this.currentItemBurnTime = this.furnaceBurnTime = getItemEmptyTime(this.furnaceItemStacks[1]);
            ...
            {
                flag1 = true;
                Purifier.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
     ...
     * fuel
     */
    public static int getItemEmptyTime(ItemStack p_145952_0_)
    {
        if (p_145952_0_ == null)
        {
            return 0;
        ...
        else
        {
            ...
            if(item == Items.water_bucket) return 2000;
            if(item == Items.potionitem) return 160;
    ...
    public static boolean isItemFuel(ItemStack p_145954_0_)
    {
         ...
         * fuel
         */
        return getItemEmptyTime(p_145954_0_) > 0;
    }
